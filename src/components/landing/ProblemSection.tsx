    ...
    <section className="py-24 md:py-32 bg-gray-50">
      <div className="container mx-auto px-6 max-w-3xl text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight mt-4">
            You're working too much.
            <br />
            <span className="text-primary">And somehow… still behind.</span>
          </h2>

          <p className="mt-6 text-lg text-gray-500 leading-relaxed max-w-md mx-auto">
          ...
          <div className="mt-10 space-y-4 max-w-md mx-auto">
            {problems.map((item, i) => (
              <motion.div
                key={i}
                className="bg-white border border-gray-200 rounded-xl px-6 py-5 text-left flex items-center gap-4 shadow-md"
          ...
          <motion.div
            className="mt-16 bg-white border border-gray-200 rounded-2xl px-8 py-10 max-w-lg mx-auto shadow-lg text-left"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}

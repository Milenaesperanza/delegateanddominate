...
const ShiftSection = () => {
  const parts = [
    { num: "01", title: "Clear Input", desc: "Define exactly what needs to be done" },
    { num: "02", title: "Clear Output", desc: "Define what success looks like" },
    { num: "03", title: "Real Autonomy", desc: "Let your team own the process" },
  ];
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6">
          {parts.map((part, i) => (
            ...
            >
              <span className="text-4xl font-black text-primary/20">{part.num}</span>
              <h3 className="mt-3 text-xl font-bold text-foreground">{part.title}</h3>
              <p className="mt-2 text-sm text-muted-foreground">{part.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <div className="bg-foreground rounded-2xl px-8 py-10 max-w-xl mx-auto">
